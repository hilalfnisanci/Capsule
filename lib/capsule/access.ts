 ...
 *
 * Content is hidden while the capsule is LOCKED, unless the viewer is the
 * owner — owners can preview their own locked capsule at any time.
 */
 ...
 * Once opened, a capsule becomes an immutable historical record.
 */
 ...
 * Only the owner may delete, regardless of capsule status.
 */
 ...
 *  - The open date must be in the past or equal to the current time.
 */
 ...
 * that are immediately openable on creation.
 */
